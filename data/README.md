...
|---|---|---|---|---|
| `technologies.csv` | HATCH: Historical Adoption of TeCHnology dataset (export) | CC BY 4.0 | ACCESS DATE TBC | Nemet, G. F., Greene, J., Zaiser, A. & Hammersmith, A. (2023), *Historical Adoption of Technologies (HATCH) Dataset (Version v2)*, Zenodo, [zenodo.org/records/10035735](https://zenodo.org/records/10035735) |
